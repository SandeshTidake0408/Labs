...
#pragma omp parallel sections // This is an OpenMP directive that tells the compiler to execute the following sections in parallel. Each section within the parallel sections block will be executed by a different thread in parallel,
        {

#pragma omp section // defines a section of code that can be executed by a separate thread
